...
class SpectrumBeam : public Beam {
 private:
  ...
  double wavelength;
  double interpolateBetweenIterators(std::map<double, double>::iterator itLow,
                                     std::map<double, double>::iterator itHigh,
                                     double wavelength);
 ...
 public:
  ...
  double getNominalWavelength() { return wavelength; }

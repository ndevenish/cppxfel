...
double RefinementStepSearch::minimizeTwoParameters(int whichParam1,
                                                   int whichParam2,
                                                   double *bestScore) {
...
double RefinementStepSearch::minimizeParameter(int whichParam,
                                               double *bestScore) {
  ...
  if (step < stepConvergences[whichParam]) return 1;
  ...
  *bestScore = param_min_score;
  ...
  if (param_min_num == 1) stepSizes[whichParam] /= 2;

...
class SpotVector : public LoggableObject {
 ...
 public:
  ...
  void addSimilarLengthStandardVectors(
  ...
  static SpotVectorPtr vectorBetweenSpotsFromArray(
  ...
  double getOriginalDistance() { return firstDistance; }

  std::vector<SpotVectorPtr> standardVectorsOfSameDistance() {
    return sameLengthStandardVectors;
  }

  double getFirstDistance() { return firstDistance; }

  bool isOnlyFromDetector(DetectorPtr detector);

  vec getHKL() { return hkl; }

  void setUpdate() { update = true; }

  vec getVector() { return spotDiff; }

  vec getUnitVector() { return unitSpotDiff; }

  SpotPtr getFirstSpot() { return firstSpot; }

  SpotPtr getSecondSpot() { return secondSpot; }

  double getH() { return hkl.h; }

  double getK() { return hkl.k; }

  double getL() { return hkl.l; }

  void setSpotDiff(vec transformedHKL) { spotDiff = transformedHKL; }
};

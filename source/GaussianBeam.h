...
class GaussianBeam : public Beam {
 private:
  ...
  double superGaussianFromTable(double x, double mean, double sigma,
                                double exponent);

 public:
  GaussianBeam(double meanWavelength, double bandwidth, double exponent);
  double integralBetweenEwaldWavelengths(double lowWavelength,
  ...
  static double getBandwidthA(void *object) { return getBandwidth(object, 0); }

  static double getBandwidthB(void *object) { return getBandwidth(object, 1); }

  static double getExponentA(void *object) { return getExponent(object, 0); }

  static double getExponentB(void *object) { return getExponent(object, 1); }

  static double getHeightA(void *object) { return getHeight(object, 0); }

  static double getHeightB(void *object) { return getHeight(object, 1); }

...
#define MTZ_MAJOR_VERSN                                \
  1 /**< MTZ file major version - keep to single digit \
     */
#define MTZ_MINOR_VERSN                                \
  1 /**< MTZ file minor version - keep to single digit \
     */
...
#define NBATCHINTEGERS                                                      \
  29                    /**< size of integer section of batch header buffer \
                         */
#define NBATCHREALS 156 /**< size of float section of batch header buffer */

#define MXTALS \
  100 /**< maximum number of crystals (for a few arrays - to be removed!) */
#define MSETS \
  1000 /**< maximum number of datasets (for a few arrays - to be removed!) */
#define MCOLUMNS \
  10000 /**< maximum number of columns (for a few arrays - to be removed!) */

...
#if defined(_AIX) || defined(__hpux) || defined(F2C) || defined(G77) || \
    defined(_WIN32) || defined(sun) /* would do no harm on others, though */
#include <time.h>
#endif
...
#define NATIVEIT DFNTI_IBO
    ...
    defined(__amd64__) || defined(__x86_64__) || defined(WIN32)
#define NATIVEIT DFNTI_IBO

...
for anEntry in entries[realMin:realMax]:
  ...
  for i in range(realEntryMin, realEntryMax):
    ...
    for panel in panelInfo:
      ...
      print panel + "\t" + str(origTopLeftX) + "\t" + str(
          origTopLeftY) + "\t" + str(origBottomRightX) + "\t" + str(
              origBottomRightY) + "\t" + str(absoluteNewX) + "\t" + str(
                  absoluteNewY) + "\t" + str(axisXX) + "\t" + str(
                      axisXY) + "\t" + str(axisYX) + "\t" + str(axisYY)
    ...
    sample['SIZE1'] = width
    sample['SIZE2'] = height
    sample['ACTIVE_AREAS'] = scitbx_array_family_flex_ext.int(
        [0, 0, width, height])
